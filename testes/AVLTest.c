ArvoreDisciplinas* arvoreDisciplinasSis2 = NULL;
    Curso* curso2 = criarCursoAVL(300, "sistemas", 8, 12, arvoreDisciplinasSis2);
    arvoreCursos2 = inserirCursoAVL(&arvoreCursos2, *curso2);
    ArvoreDisciplinas* arvoreDisciplinasPed = NULL;
    Curso* curso3 = criarCursoAVL(500, "pedagogia", 10, 9, arvoreDisciplinasPed);
    arvoreCursos2 = inserirCursoAVL(&arvoreCursos, *curso3);
    ArvoreDisciplinas* arvoreDisciplinasHis = NULL;
    Curso* curso4 = criarCursoAVL(100, "historia", 8, 9, arvoreDisciplinasHis);
    arvoreCursos = inserirCursoAVL(&arvoreCursos, *curso4);
    ArvoreDisciplinas* arvoreDisciplinasMed = NULL;
    Curso* curso5 = criarCursoAVL(400, "medicina", 10, 15, arvoreDisciplinasMed);
    arvoreCursos = inserirCursoAVL(&arvoreCursos, *curso5);
    ArvoreDisciplinas* arvoreDisciplinasNut = NULL;
    Curso* curso6 = criarCursoAVL(700, "nutricao", 8, 12, arvoreDisciplinasNut);
    arvoreCursos = inserirCursoAVL(&arvoreCursos, *curso6);
    ArvoreDisciplinas* arvoreDisciplinasBio = NULL;
    Curso* curso7 = criarCursoAVL(800, "ciências biológicas", 10, 9, arvoreDisciplinasBio);
    arvoreCursos = inserirCursoAVL(&arvoreCursos, *curso7);
    ArvoreDisciplinas* arvoreDisciplinasLet = NULL;
    Curso* curso8 = criarCursoAVL(600, "letras", 8, 9, arvoreDisciplinasLet);
    arvoreCursos = inserirCursoAVL(&arvoreCursos, *curso8);
