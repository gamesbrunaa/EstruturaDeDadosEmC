...
void *inserirFim(Conta *lista);//inserir elemento em qq lugar de acordo com o valor informado pelo usuario, essa ordem deve ser Crescente
void *inserirOrdenado(Conta *lista);//inserir elemento em qq lugar de acordo com o valor informado pelo usuario, essa ordem deve ser Crescente
