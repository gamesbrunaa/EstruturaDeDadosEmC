...
int main(){
    ...
    Fila *f2 = criar_fila(); // fila da devolu��o de produtos

    do{
        printf("\n\t 0 - SAIR \n\t 1- INSERIR CLIENTE \n\t 2- REMOVER CLIENTE \n\t 3- MOSTRAR CLIENTES \n\t 4- BUSCAR CLIENTE \n\t 5- VERIFICAR LISTA VAZIA \n\t 6- LIBERAR LiSTA \n\t 7- MENU ENTREGAS \n\t 8- MENU ENTREGAS N�O EFETUADAS \n\t 9- MENU DEVOLU��O DE PRODUTOS \n\t");
        ...
        switch(op){
            ...
            case 7:
                ...
                break;
            case 8:
                printf("\n\t 0 - VOLTAR \n\t 1- INSERIR ENTREGAS N�O EFETUADAS \n\t 2- MOSTRAR ENTREGAS \n\t 3- REMOVER ENTREGA \n\t 4- VERIFICAR PILHA VAZIA \n\t 5- LIBERAR PILHA \n\t");
                printf("Digite a op��o desejada: ");
                scanf("%d", &op3);
                switch (op3){
                case 1:
                ...
                break;
            case 9:
                printf("\n\t 0 - SAIR \n\t 1- INSERIR DEVOLU��O DE PRODUTOS \n\t 2- MOSTRAR DEVOLU��O DE PRODUTOS \n\t");
                printf("Digite a op��o desejada: ");
                scanf("%d", &op4);
                switch (op4){
                case 1:
